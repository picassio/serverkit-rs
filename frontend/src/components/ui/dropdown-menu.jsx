...
// Styling lives in styles/components/_ui.scss (.ui-dropdown-*). JSX only
// composes classes; geometry/color/animation are SCSS-owned.
...
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn('ui-dropdown-sub-trigger', inset && 'ui-dropdown-inset', className)}
    {...props}
  >
    {children}
    <ChevronRight className="ui-dropdown-chevron" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
const DropdownMenuCheckboxItem = React.forwardRef(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn('ui-dropdown-checkbox-item', className)}
    checked={checked}
    {...props}
  >
...
const DropdownMenuRadioItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn('ui-dropdown-radio-item', className)}
    {...props}
  >
    <span className="ui-dropdown-item-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
